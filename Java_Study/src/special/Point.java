...
class Point {
	   private int x, y;	// 정수형 변수 x, y (private 선언)
	   ...
	   public int getX() {	// getX 메소드 
		   return x; 
	   }
	   
	   public int getY() {	// getY 메소드 
		   return y; 
	   }
	   
	   protected void move(int x, int y) { // move 메소드 (상속자 지정)
		   // 생성자와 동일한 역할을 담당
		   // 각각 x, y 에 간접 접근해주는 메소드
		   this.x = x; 
		   this.y = y; 
	   }	
	}
